...
class SettingsPage(BasePage):
    ...
    def build_ui(self):
        ...
        # 1. 標題
        ctk.CTkLabel(self, text="設定與關於", font=ctk.CTkFont(size=24, weight="bold")).grid(row=0, column=0, pady=(20, 30), sticky="w", padx=30)

        # 2. 外觀模式
        self.appearance_frame = ctk.CTkFrame(self)
        self.appearance_frame.grid(row=1, column=0, padx=30, pady=10, sticky="ew")
        ctk.CTkLabel(self.appearance_frame, text="介面主題:").pack(side="left", padx=20, pady=15)
        ...
        self.mode_menu.pack(side="left", padx=10, pady=15)
